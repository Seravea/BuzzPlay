...
#ifndef BUZZPLAY_SWIFT_H
#define BUZZPLAY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BuzzPlay",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC8BuzzPlay10MPCService")
@interface MPCService : NSObject
...
@class NSData;
@class MCSession;
@interface MPCService (SWIFT_EXTENSION(BuzzPlay)) <MCNearbyServiceAdvertiserDelegate>
...
@class NSString;
@interface MPCService (SWIFT_EXTENSION(BuzzPlay)) <MCNearbyServiceBrowserDelegate>
...
@class NSProgress;
@class NSURL;
@interface MPCService (SWIFT_EXTENSION(BuzzPlay)) <MCSessionDelegate>
